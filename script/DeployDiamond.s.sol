...
contract DiamondUpgradeExample is Script, DiamondUpgradeHelper {
    function run() external {
        ...
        // IDiamondCut.FacetCut[] memory cuts = _deployFacetsAndBuildCuts();
        // executeDiamondCut(IDiamondCut(address(diamond)), cuts, address(0), "");
        // ERC721Facet(address(diamond)).setReqData(_defaultReqData());


        ERC721Facet(0x61361D16febBE27b0ab9E5B02506A05035cC5ebc).erc721mint(deployer);
        ERC721Facet(0x61361D16febBE27b0ab9E5B02506A05035cC5ebc).erc721mint(deployer);
        ERC721Facet(0x61361D16febBE27b0ab9E5B02506A05035cC5ebc).erc721mint(deployer);
        ERC721Facet(0x61361D16febBE27b0ab9E5B02506A05035cC5ebc).erc721mint(deployer);
    ...
    // function _deployFacetsAndBuildCuts() internal returns (IDiamondCut.FacetCut[] memory cuts) {
    ...
    //     return buildAddCutsByNames(addAddresses, names);
    // }
